...
class PortfolioService:
    ...
    @classmethod
    def get_current_price(cls, commodity: str) -> Optional[float]:
        """
    ...
    @classmethod
    def enrich_position_with_current_data(cls, position: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        metrics = cls.calculate_position_metrics(quantity, purchase_price, current_price)
